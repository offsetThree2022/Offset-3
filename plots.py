...
from model import OffsetThree, OffsetThreeMGDA, FeatEncoder
...
def vis_scene_data(nuscenes_path=None, nuscenes_version='v1.0-trainval', which_scene=0, max_seq_num=10,
                   begin_frame=0, frame_skip=3, trained_model_path=None, img_save_dir=None, which_model='OffsetThree',
    ...
    which_model: which network ['OffsetThree'/'OffsetThreeMGDA']
    ...
    loaded_models = list()
    if which_model == "OffsetThree":
        model = OffsetThree(out_seq_len=20, motion_category_num=2, height_feat_size=13)
        ...
        model_head = OffsetThreeMGDA(out_seq_len=20, motion_category_num=2)
...
def vis_model_per_sample_data(bev_input_data, data_dict, frame_skip=3, voxel_size=(0.25, 0.25, 0.4),
                              loaded_models=None, which_model="OffsetThree", model_path=None, img_save_dir=None,
    ...
    which_model: which model to apply ['OffsetThree'/'OffsetThreeMGDA']
...
if __name__ == "__main__":
    ...
    parser.add_argument('--net', default='OffsetThree', type=str, help='Which network [OffsetThree/OffsetThreeMGDA]')
